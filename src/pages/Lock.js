...
import { faEye, faUnlockAlt, faAngleLeft, faUserCircle } from "@fortawesome/free-solid-svg-icons";
                ...
                <Container>
                    {<p className="text-center">
                        <Card.Link as={Link} to="/my-business/login" className="text-dark">
                            <FontAwesomeIcon icon={faAngleLeft} className="me-2" /> Sign in with a different account
                        </Card.Link>
                    </p>}
                            ...
                            <div className="bg-white shadow-soft rounded p-4 p-lg-5 w-100 fmxw-500">
                                <div className="text-center text-md-center mb-4 mt-md-0">
                                    ...
                                    <div className="text-center text-md-center mb-4 mt-md-0">
                                            ...
                                            { userData?._embedded?.CustomFields?._embedded?.ProfileImage ?
                                            ...
                                            :
                                            <FontAwesomeIcon icon={faUserCircle} className="text-gray display-1 my-3" />
                                            } 
