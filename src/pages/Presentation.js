          ...
          <Row>
            <Col xs={12} className="text-center">
              ...
              <div className="d-flex align-items-center justify-content-center">
                <Button variant="secondary" as={Link} to={AllRoutes.DashboardOverview.path} className="text-dark me-3">
        ...
        <Container>
          <Row className="justify-content-between align-items-center mb-5 mb-lg-7">
            <Col lg={5} className="order-lg-2 mb-5 mb-lg-0">
              ...
              <Button as={Link} to={AllRoutes.DashboardOverview.path} variant="secondary" target="_blank">Live Demo <FontAwesomeIcon icon={faExternalLinkAlt} className="ms-1" /></Button>
          ...
          <Row className="justify-content-between align-items-center mb-5 mb-lg-7">
            <Col lg={5}>
              ...
              <Button as={Link} to={AllRoutes.Forms.path} variant="secondary" className="mb-5 mb-lg-0" target="_blank"><FontAwesomeIcon icon={faReact} className="me-1" /> Components examples</Button>
            </Col>
          ...
          <Row className="d-flex align-items-center">
            <Col xs={12} lg={6} className="mb-4">
              <div className="d-none d-lg-block mt-5">
                ...
                <Button as={Link} variant="secondary" size="md" to={AllRoutes.DocsFolderStructure.path} target="_blank" className="text-dark">
          ...
          <Row className="justify-content-center">
            <Col md={10} xl={9}>
              ...
              <p className="mt-4 text-white text-center mb-0">
                Looks unfamiliar? Don’t worry! Our <Link to={AllRoutes.DocsQuickStart.path} className="text-white text-underline fw-bold" target="_blank">documentation</Link> has got you covered.
              </p>
            </Col>
          </Row>
        </Container>
        ...
        <Container>
          <Row>
            ...
            <Col xs={6} md={2} className="mb-5 mb-lg-0">
              ...
              <ul className="links-vertical mt-2">
                <li>
                  <Card.Link as={Link} to={AllRoutes.DocsQuickStart.path} target="_blank">Getting started</Card.Link>
                </li>
                <li><Card.Link as={Link} to={AllRoutes.DocsChangelog.path} target="_blank">Changelog</Card.Link></li>
