...
import { Breadcrumb, Row, Col, Form, Card, Image, OverlayTrigger, Tooltip, Button, Tab, Nav } from "react-bootstrap";
                                    ...
                                    <Card border="light" className="table-wrapper table-responsive shadow-sm">
                                        <Tab.Content>
                                            ...
                                            <Tab.Pane eventKey="tab-1">
                                                <FilterableEventsTable events={upcoming_events}/>    
                                            </Tab.Pane>
                                            
                                            {/* past events */}
                                            <Tab.Pane eventKey="tab-2">
                                                <FilterableEventsTable events={past_events}/>    
                                            </Tab.Pane>
